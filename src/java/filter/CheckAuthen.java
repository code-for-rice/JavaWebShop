 ...
 * @author Dell
 */
public class CheckAuthen implements Filter {
    ...
    private static String LOGIN_PAGE = "view/Public_Pages/login.jsp";
    private static String HOME_PAGE = "view/Public_Pages/home.jsp";
    ...
    public CheckAuthen() {
        ...
        ADMIN_FUNCTION.add(".jsg");
        ADMIN_FUNCTION.add(".png");
        ADMIN_FUNCTION.add("images/sanPham");
        ADMIN_FUNCTION.add("view/JSP");
        ADMIN_FUNCTION.add("view/Other_pages");
        ADMIN_FUNCTION.add("view/Private_pages");
        ADMIN_FUNCTION.add("view/Public_pages");

        USER_FUNCTION = new ArrayList<>();
        USER_FUNCTION.add("login.jsp");
        USER_FUNCTION.add("MainController");
        USER_FUNCTION.add("LoginServlet");
        USER_FUNCTION.add(".jsg");
        USER_FUNCTION.add(".png");

        NON_AUTHEN_FUNCTION = new ArrayList<>();
        NON_AUTHEN_FUNCTION.add(".jsg");
        NON_AUTHEN_FUNCTION.add(".png");
        NON_AUTHEN_FUNCTION.add("images/sanPham");
        NON_AUTHEN_FUNCTION.add("view/JSP");
        NON_AUTHEN_FUNCTION.add("view/Other_pages");
        NON_AUTHEN_FUNCTION.add("view/Private_pages");
        NON_AUTHEN_FUNCTION.add("view/Public_pages");
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("CheckAuthen:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckAuthen:DoAfterProcessing");
        }
...
//
        ...
        try {
            ...
            if (uri.contains(".jpg") || uri.contains(".png") || uri.contains("login.jsp")
                    || uri.contains("MainController") || uri.contains("LoginServlet") || uri.contains("ProductController")) {
                ...
                for (String value : NON_AUTHEN_FUNCTION) {
                ...
                if (checkContain) {
                    ...
                    if (session == null || session.getAttribute("u") == null) {
                        wrappedRequest.getRequestDispatcher("/LoginServlet").forward(request, response);
                    } else {
                        Accounts a = (Accounts) session.getAttribute("u");
                        //wrappedRequest.getRequestDispatcher(HOME_PAGE).forward(request, response);
                        }
                    }
                }
...
//            // rethrow the problem after that.
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CheckAuthen: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("CheckAuthen(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CheckAuthen::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CheckAuthen::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CheckAuthen::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CheckAuthen::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CheckAuthen::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
